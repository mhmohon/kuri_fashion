...
<!-- Start content -->
	...
	<div class="row">
		<div class="col-xs-12">
			<div style="background: url('http://lily-tms.herokuapp.com/images/bg3.jpg'); margin: 0px -20px; background-position: bottom;">
				<div style="background-color: rgba(62, 74, 89, 0.69);">
					<div class="page-title-box" style="margin: 0; margin-bottom: 20px; background-color: transparent;">
						...
						<div class="col-sm-6 col-md-6 col-xs-12">
							<p class="text-muted" style="font-size: 20px; font-weight: 800 ">Welcome Administrator</p>
						</div>
		...
		<div class="col-lg-3 col-md-6">
			<div class="card-box widget-box-two widget-two-success">
				...
				<div class="wigdet-two-content text-white">
					...
					<h2 class="text-white"><span data-plugin="counterup">0</span></h2>
		...
		<div class="col-lg-3 col-md-6">
			<div class="card-box widget-box-two widget-two-warning">
				...
				<div class="wigdet-two-content text-white">
					...
					<h2 class="text-white"><span data-plugin="counterup">4</span></h2>
		...
		<div class="col-lg-3 col-md-6">
			<div class="card-box widget-box-two widget-two-danger">
				...
				<div class="wigdet-two-content text-white">
					...
					<h2 class="text-white"><span data-plugin="counterup">5100</span></h2>
					<p class="m-0"><b>Total</b></p>
				</div>
			</div>
		</div>
					...
					<div class="card-box widget-box-one">
						<table width="100%" class="text-center">
							<tr>
								...
								<td style="width: 50%;">
									<div class="h1 font-w700"><span class="h2 text-muted">+14</span> </div>
				...
				<div class="col-md-4">
					<div class="card-box widget-box-one">
						<div class="wigdet-one-content">
							...
							<h2 class="text-warning"><span data-plugin="counterup">5</span></h2>
				...
				<div class="col-md-4">    
					<div class="card-box widget-box-one">
						<div class="wigdet-one-content">
							...
							<h2 class="text-success"><span data-plugin="counterup">0</span></h2>
							<p class="text-muted m-0"><b>CURRENT MONTH</b></p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="card-box widget-box-one">
						<div class="wigdet-one-content">
							...
							<h2 class="text-warning"><span data-plugin="counterup">$7467</span></h2>
							<p class="text-muted m-0"><b>CURRENT MONTH</b></p>
						</div>
					</div>
				</div>    
				<div class="col-md-4">    
					<div class="card-box widget-box-one">
						<div class="wigdet-one-content">
							...
							<h2 class="text-success"><span data-plugin="counterup">$2367</span></h2>
							<p class="text-muted m-0"><b>CURRENT MONTH</b></p>
						</div>
					</div>
				</div>
				<div class="col-md-4">    
					<div class="card-box widget-box-one">
						<div class="wigdet-one-content">
							...
							<h2 class="text-danger"><span data-plugin="counterup">$5100</span></h2>
							<p class="text-muted m-0"><b>CURRENT MONTH</b></p>
						</div>
					</div>
				</div>
